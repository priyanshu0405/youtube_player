...
import 'package:youtube_player/screen/video_screen.dart';
import 'package:youtube_player/services/api_services.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _initChannel() async {
    Channel channel = await APIService.instance
        .fetchChannel(channelId: 'UCpVm7bg6pXKo1Pr6k5kxG9A');
    setState(() {
      _channel = channel;
    });
  }
